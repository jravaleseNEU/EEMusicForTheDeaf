...
//    Serial.print("SpectrumValueR = ");Serial.println(spectrumValueR[i]);
//    Serial.print("SpectrumValueL = ");Serial.println(spectrumValueL[i]);
    //remove noise
...
//    Serial.println(maxOut); 
  float r,g,b;
  float moreR, moreO, moreY, moreG, moreB, moreI, moreV;
  switch (maxi) {
...
//      Serial.println("Case 5");
      ...
      Serial.print("Case 5 BLUE: ");Serial.println(b);
      r = 0;
      g = 0;
